...
# We want to take some care to create
# X1 and X2 such that they are not correlated
shape = (25,1)
...
# To prepare to fit a linear model, we'll want to
...
## using Equation (6) and abstract vector space approaches)
## We need the transpose to keep inner dimensions consistent
...
# The output of all dot products is a 1x1 matrix.
